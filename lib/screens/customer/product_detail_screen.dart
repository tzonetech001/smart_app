          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  'Offer: Add ${recommendedProduct.productName} now and get it for Tsh ${(recommendedProduct.price * (1.0 - discountPercent)).toStringAsFixed(0)} (normally Tsh ${recommendedProduct.price.toStringAsFixed(0)})!',
