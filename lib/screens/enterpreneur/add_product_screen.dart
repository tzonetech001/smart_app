...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  // Take photo from camera (mobile only; on web will fallback or show error)
  Future<void> _takePhotoFromCamera() async {
    try {
      ...
      _showErrorSnackBar('Camera not available or error: $e');
    }
  }
  ...
  // Upload image to Firebase Storage (works on all platforms)
                  ...
                  child: Container(
                    ...
                    child: _imageBytes != null
                        ? Stack(
                            fit: StackFit.expand,
                            children: [
                              // Display selected image using MemoryImage (web compatible)
                              ClipRRect(
                                borderRadius: BorderRadius.circular(16),
                                child: Image.memory(
                                  _imageBytes!,
